...
def generate_model(test_filename, train_X, train_Y, test_X, test_Y):
    ...
    h_conv2 = conv2d_bn(h_pool1, W_conv2, is_training, 'relu')
    ...
    h_fc1 = fully_bn_layer(h_pool2_flat, W_fc1, is_training)
    ...
    y_conv = fully_bn_layer(h_fc1, W_fc2, is_training, activation='None')
